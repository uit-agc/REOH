...
int main(int argc, char **argv){
	...
	int BLOCK_SIZE;
#ifdef USE_GPU
	char *rv = getenv("NW_BLOCK_SIZE");
	if (rv != NULL) {
		BLOCK_SIZE = atoi(rv);
		printf("NW initialize BLOCK_SIZE: %d\n", BLOCK_SIZE);
	}
#else
  ...
  printf("WG size of kernel = %d \n", BLOCK_SIZE);
	...
	clSetKernelArg(kernel1, 12, sizeof(cl_int), (void*) &BLOCK_SIZE);
	...
	clSetKernelArg(kernel2, 12, sizeof(cl_int), (void*) &BLOCK_SIZE);
