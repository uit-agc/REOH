...
#ifdef USE_GPU
	char *rv = getenv("CFD_BLOCK_SIZE_0");
	if (rv != NULL) {
		BLOCK_SIZE_0 = atoi(rv);
	}
	rv = getenv("CFD_BLOCK_SIZE_1");
	if (rv != NULL) {
		BLOCK_SIZE_1 = atoi(rv);
	}
	rv = getenv("CFD_BLOCK_SIZE_2");
	if (rv != NULL) {
		BLOCK_SIZE_2 = atoi(rv);
	}
	rv = getenv("CFD_BLOCK_SIZE_3");
	if (rv != NULL) {
		BLOCK_SIZE_3 = atoi(rv);
	}
	rv = getenv("CFD_BLOCK_SIZE_4");
	if (rv != NULL) {
		BLOCK_SIZE_4 = atoi(rv);
	}
#endif
